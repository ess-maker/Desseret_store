      ...
      <form action="" method="POST">
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            className="max-w-96 h-62 resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-10 text-2xl text-[#6B7280] outline-none focus:border-primary focus:shadow-md"
          >
          </textarea>
        </div>
